...
export const ADD_BRAND_AND_CATEGORY_MESSAGE =
  "Добавьте хотя бы одну категорию и один бренд";
...
// Alert messages
export const DELETE_CATEGORY_ALERT_MESSAGE =
  "Сначала удалите все товары из категории";
...
export const FIRST_ORDER_REGISTER_ALERT =
  "Получите 50% скидки на первый заказ при регистрации.";
...
export const CREATE_CATEGORY_ERROR_MESSAGE =
  "Не удалось создать категорию. Попробуйте позже";
...
export const FETCH_BRANDS_ERROR_MESSAGE =
  "Не удалось загрузить бренды. Попробуйте позже";
export const CREATE_BRAND_ERROR_MESSAGE =
  "Не удалось создать бренд. Попробуйте позже";
export const UPDATE_BRAND_ERROR_MESSAGE =
  "Не удалось обновить данные. Попробуйте позже";
export const DELETE_BRAND_ERROR_MESSAGE =
  "Не удалось удалить бренд. Попробуйте позже";

// Product slice error messages
export const FETCH_PRODUCTS_ERROR_MESSAGE =
  "Не удалось загрузить товары. Попробуйте позже";
export const CREATE_PRODUCT_ERROR_MESSAGE =
  "Не удалось создать товар. Попробуйте позже";
export const UPDATE_PRODUCT_ERROR_MESSAGE =
  "Не удалось обновить данные. Попробуйте позже";
...
export const CREATE_ORDER_ERROR_MESSAGE =
